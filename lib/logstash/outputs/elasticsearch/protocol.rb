            ...
            unless args[:_id].nil?
              ...
              if @options[:doc_as_upsert]
                request.docAsUpsert(true)
				  ...
				  request.script(args[:_script]) if args[:_script]
				  request.scriptParams(args[:_script_params]) if args[:_script_params]
				  request.scriptedUpsert(args[:_scripted_upsert]) if args[:_scripted_upsert]
				  request.scriptLang(args[:_script_lang]) if args[:_script_lang]
